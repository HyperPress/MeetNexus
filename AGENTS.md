...
- 项目文档、README、代码注释、提交说明、Pull Request 说明和面向开发者的操作提示默认使用简体中文。
- Web 界面的标题、按钮、表单、提示、错误信息、空状态和无障碍文本必须使用简体中文；未经明确需求不得混用英文界面文案。
- 面向用户返回的 API 错误信息使用简体中文，稳定的错误码保持英文大写或约定格式，便于程序判断。
- 技术名称、协议名称、库名、命令、文件路径、代码标识符、环境变量和第三方产品名可以保留其官方英文写法。
- 引入第三方英文模板后，必须在同一任务中删除或翻译其示例说明和默认界面文案。
