...
当前已完成工程基础、房间 PostgreSQL/Redis 模块、中文房间入口、会前设备预览、房间成员 JWT 鉴权、WebSocket 实时事件、同源 WHIP/WHEP 媒体代理、基础多人音视频闭环及 Live777 逐成员录制任务。已实现仅会议成员可访问的受保护回放文件接口；浏览器播放器尚未实现。
